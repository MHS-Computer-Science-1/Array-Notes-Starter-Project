Public Class Form1
    ...
    'Sub: displayWinner
    'Parameters: 2 scores
    'Task: Display who wins
    Sub displayWinner(s1 As Integer, s2 As Integer)
        If s1 > s2 Then
    ...
    Sub displayArea(b As Integer, h As Integer)
        Dim area As Integer
        area = 0.5 * b * h
        MsgBox(area)
    End Sub
